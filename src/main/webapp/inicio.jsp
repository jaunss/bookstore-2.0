...
<body>
	...
	<div style="width: 600px; height: 600px; margin: 0 auto;">
		<canvas class="my-4 w-100" id="chartLivros" width="600px"
			height="600px"></canvas>
	</div>
	...
	<script>
		...
		new Chart(ctx, {
			type : 'bar',
			data : {
				labels : [ 'Tecnologia', 'Romance', 'Gestão de Pessoas',
						'Administração', 'Contabilidade' ],
				datasets : [ {
					label : '# Gênero de Livros mais comprados',
					data : [ 19, 6, 13, 10, 17, 18 ],
					borderWidth : 1,
